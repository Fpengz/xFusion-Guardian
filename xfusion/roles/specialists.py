"""Specialist agents for XFusion v0.2.4.2.
    ...
    def propose(self, state: AgentGraphState, analysis: dict[str, Any]) -> dict[str, Any]:
        ...
        if analysis["has_plan"]:
            ...
            return {
                ...
                "recommendation": "continue_execution" if analysis["interaction_state"] == "executing" else "await_input",
            }
        else:
...
class ObservationAgent(SpecialistAgent):
    ...
    def propose(self, state: AgentGraphState, analysis: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "needed_observations": analysis["available_observation_capabilities"][:3],  # Top 3 suggestions
        }
...
class VerificationAgent(SpecialistAgent):
    ...
    def analyze(self, state: AgentGraphState) -> dict[str, Any]:
        ...
        return {
            ...
            "existing_verification": existing_verification.model_dump() if existing_verification else None,
...
class ExplanationAgent(SpecialistAgent):
    ...
    def propose(self, state: AgentGraphState, analysis: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "latest_status": analysis["recent_audit_summary"][-1]["status"] if analysis["recent_audit_summary"] else None,
            "repair_count": analysis["repair_proposals_count"],
            "safe_next_steps": safe_next_steps,
        }


def build_specialist_agents(registry: CapabilityRegistry | None = None) -> dict[ReasoningRole, SpecialistAgent]:
