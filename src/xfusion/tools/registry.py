...
class ToolRegistry:
    ...
    def __init__(
        ...
        self.tools: dict[str, Callable[..., ToolOutput]] = {
            ...
            "system.service_start": system_tools.service_start,
            "system.service_stop": system_tools.service_stop,
            "system.service_restart": system_tools.service_restart,
            "system.service_reload": system_tools.service_reload,
            "system.list_services": system_tools.list_services,
            "system.restart_failed_services": system_tools.restart_failed_services,
            ...
            "file.append_file": file_tools.append_file,
            "file.write_file": file_tools.write_file,
            "file.delete": file_tools.delete,
            "file.move": file_tools.move,
            "file.copy": file_tools.copy,
            "file.chmod": file_tools.chmod,
            "file.chown": file_tools.chown,
            "process.list": process_tools.list,
            "process.find_by_port": process_tools.find_by_port,
            "process.kill": process_tools.kill,
            "process.inspect": process_tools.inspect,
            "process.zombie_procs": process_tools.zombie_procs,
            "process.terminate_by_name": process_tools.terminate_by_name,
