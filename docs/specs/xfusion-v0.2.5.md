# XFusion v0.2.5 Spec: Agent-Led Hybrid Execution

## Summary

XFusion v0.2.5 introduces a Conversation Gateway before orchestration and an
...
v0.2.5 defines four agent roles:
...
`PlanStep` includes v0.2.5 execution metadata:
...
v0.2.5 adds the domain contracts and guardrails needed for agent-led hybrid
